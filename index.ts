...
//     nome:"tv",
//     preco: 3000,
//     descricao: "tv de 99 polegadas"
// }

// console.log(objetoProduto1)

// const palavra: string = "alessandra"
// console.log(palavra.toUpperCase()) // deixa a palavra em maiusculo

//ARRAY
// const listaDeNumeros: number[] = [1, 2, 3, 13]
// console.log(listaDeNumeros)
// console.log(listaDeNumeros.length) // length mostra o tamanho do array
// console.log(listaDeNumeros[0]) // [0] mostra o primeiro elemento do array
...
const marcarComoLida = function (lista: Notificacao[], id: number): string {
  ...
  if (!lista[0] || !lista[1] || !lista[2])
    return "Lista insuficiente para este exercício";
...
function comandoAjuda(comando: "listar" | "ler" | "filtrar" | string): string {
  switch (comando) {
    ...
    case "filtrar":
      return "Filtra por tipo";
    default:
      return "Comandos: listar | ler | filtrar";
  }
}
...
console.log(
  ...
  inbox[0]!.titulo,
  inbox[0]!.tipo,
  statusLeitura(inbox[0]!)
);
console.log(
  inbox[1]!.id,
  inbox[1]!.titulo,
  inbox[1]!.tipo,
  statusLeitura(inbox[1]!)
);
console.log(
  inbox[2]!.id,
  inbox[2]!.titulo,
  inbox[2]!.tipo,
  statusLeitura(inbox[2]!)
);
